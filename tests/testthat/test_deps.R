...
test_that("basic example works", {
  ...
  expect_string(ps$check(x, check_dependencies = TRUE), fixed = "The parameter 'th_param_int' can only be set")
  x = list(th_param_int = 1, th_param_fct = "a")
  expect_true(ps$check(x, check_dependencies = TRUE))
  x = list(th_param_int = 1, th_param_fct = "b")
  expect_string(ps$check(x, check_dependencies = TRUE), fixed = "The parameter 'th_param_int' can only be set")
  x = list(th_param_int = NA, th_param_fct = "b")
  expect_string(ps$check(x, check_dependencies = TRUE), fixed = "May not be NA")
...
test_that("nested deps work", {
  ...
  expect_string(ps$check(x1, check_dependencies = TRUE), fixed = "The parameter 'th_param_int' can only be set")
  x2 = list(th_param_int = 1, th_param_fct = "b")
  expect_true(ps$check(x2, check_dependencies = TRUE))
  x3 = list(th_param_int = 1, th_param_fct = "c")
  expect_string(ps$check(x3, check_dependencies = TRUE), fixed = "The parameter 'th_param_int' can only be set")
  x4 = list(th_param_fct = "a")
  expect_true(ps$check(x4, check_dependencies = TRUE))
  x5 = list(th_param_dbl = 1.3)
  expect_string(ps$check(x5, check_dependencies = TRUE), fixed = "The parameter 'th_param_dbl' can only be set")
  x6 = list(th_param_fct = "c", th_param_lgl = TRUE, th_param_dbl = 3)
  expect_true(ps$check(x6, check_dependencies = TRUE))
})
...
test_that("adding 2 sets with deps works", {
  ...
  expect_true(ps1$test(list(x1 = "a", y1 = 1, x2 = "a", y2 = 1), check_dependencies = TRUE))
  expect_true(ps1$test(list(x1 = "a", y1 = 1), check_dependencies = TRUE))
  expect_false(ps1$test(list(x1 = "b", y1 = 1), check_dependencies = TRUE))
  expect_true(ps1$test(list(x2 = "a", y2 = 1), check_dependencies = TRUE))
  expect_false(ps1$test(list(x2 = "b", y2 = 1), check_dependencies = TRUE))
})
...
test_that("we can also dep on integer", {
  ...
  expect_true(ps$check(list(i = 2, d = 5), check_dependencies = TRUE))
  expect_string(ps$check(list(i = 5, d = 5), check_dependencies = TRUE))
})
