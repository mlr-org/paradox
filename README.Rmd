...
<!-- badges: start -->
[![R CMD Check via {tic}](https://github.com/mlr-org/paradox/workflows/R%20CMD%20Check%20via%20{tic}/badge.svg?branch=master)](https://github.com/mlr-org/paradox/actions)
[![CRAN status](https://www.r-pkg.org/badges/version/paradox)](https://CRAN.R-project.org/package=paradox)
[![Cran Checks](https://cranchecks.info/badges/worst/paradox)](https://cran.r-project.org/web/checks/check_results_paradox.html)
...
Further documentation can be found in the [mlr3book](https://mlr3book.mlr-org.com/paradox.html).
