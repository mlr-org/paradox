...
ps = ParamSet$new(
  params = list(
    ...
    ParamFloat$new(id = "x", lower = -10, upper = 10),
    ParamBool$new(id = "switch"),
    ParamCateg$new(id = "methods", values = c("a","b","c"))
  )
)
```
...
ps = ParamSet$new(
  params = c(
    ...
    repeatParam(2, ParamFloat$new(id = "x", lower = 0, upper = 1))
  )
)
...
ps = ParamSet$new(
  params = list(
    ...
    ParamFloat$new(id = "x", lower = 0, upper = 1)
  ),
...
ps = ParamSet$new(
  params = c(
    ...
    repeatParam(4, ParamFloat$new(id = "x", lower = 0, upper = 1))
  ),
