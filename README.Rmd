...
Sometimes it is useful to have multiple copies of a parameter, akin to a vector. The `Param$rep()` function creates a `ParamSet` with repeated entries of the parameter.
