...
Alternatively, `logscale = TRUE` can be set; in this case, `lower` and
...
Further documentation can be found in the [in-depth
tutorial](https://paradox.mlr-org.com/dev/articles/indepth.html)
