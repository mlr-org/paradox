...
Paradox 2 does not execute the old private R6 layout implicitly. Upgrade a
legacy object explicitly after reading it, and operate only on the returned
current object:
...
should use the Paradox-owned `ParamSetShadow`; owners of unsupported legacy
subclasses must reconstruct their current public object around upgraded state.
